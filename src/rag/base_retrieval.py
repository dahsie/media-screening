        ...
        for index, item in enumerate(self.all_results):
            ...
            try :
                ...
                for index1, location in enumerate(item['locations']):
                    ...
                    elif 'country' in location_keys and (location['country'] is None or location['country'].lower() in self.liste): # some modifications have been introduce here . This is the old line of code with else condition, the elif condition will be changed to if and else in order to translate the country into english
                        #location['country'] = ''
