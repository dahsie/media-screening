...
sys.path.append("../")
from src.rag.base_retrieval import *
from src.output_parsers.output_parsers import *
from src.prompts import strike_rag_prompts
from src.questions import strike_rag_questions
...
class StrikeRAG(RetrivalBase):
    ...
    def __init__(self, google_api_key: str, vertexai_llm='gemini-1.5-flash',
        ...
        super(StrikeRAG, self).__init__(google_api_key = google_api_key, vertexai_llm=vertexai_llm,
