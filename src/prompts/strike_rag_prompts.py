...
from media.src.output_parsers.output_parsers import AutomotiveSector, BusinessSectors, Company, Temporality, LaborStrike
...
prompt1 = PromptTemplate(
    ...
    Additionally, please provide the city and country where the strike is occurring, taking place, or expected to happen. 
    The country must be translate into english, for exemple if the detected country are 'France' it must be translate into english spelling to be 'French', 'Italia' or 'Italie' must translate into 'Italy', etc.
    Present your answer in JSON format as the following instructions format following instructions format : {format_instructions}.""",
