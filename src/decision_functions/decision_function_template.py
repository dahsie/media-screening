"""If new event is implemented, it is essential to provide a decision function which describe how one can deem the relevancy of that given event. 
The function must return a boolean in order to match the rest of the pipeline. 
