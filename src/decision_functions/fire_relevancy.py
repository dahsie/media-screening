def fire_relevancy(item: dict, args : dict) -> bool:
    ...
    matching_level = item['matching_level'] == 'company-country' or item['matching_level'] == 'company-city-country' # here the relevent news also take into account the level of matching. 
                                                                                                                     # We only consider the articles with matching level either 'company-country' or 'company-country-city'as relevent. 
                                                                                                                     # The one with matching level equal to 'company' are not consider here as relevent. 


    if (is_sector_relevant and is_event_nature_qualified and is_company_impacted and is_automotive_concerned and is_supplier_yes and matching_level):
        return True
    return False