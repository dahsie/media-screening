...
from src.utils.utils_gcp import create_logger
# from src.translation.dataikugoogletranslation_copy import DataikuGoogleTranslate
...
class Configuration:
    ...
    -------
        to add
    """
    def __init__(self, project_id : str, final_config_file: str, location : str = "global", source_language_code: str = "en", initial_config_file : str=None, initial_config_dict : dict =None):
        """
        ...
        self.__source_language_code = source_language_code
    ...
    #     return  validate_target_language_code(language_code: str)
    ...
    def __translate_keywords(self, list_of_texts: list[str],  target_language_code : str) -> translate.TranslationServiceClient:
        """
        ...
        request={"parent": self.__parent,
                ...
                "source_language_code":self.__source_language_code,
                "target_language_code": target_language_code}
        if self.__source_language_code == target_language_code :
    ...
    def __news_config(self):
        ...
        for item in self.__country_lang_dict:
            ...
            for lang in item['lang'] :
                translated_keywords = self.__translate_keywords(list_of_texts = keywords,  target_language_code  = lang)
                news_configs.append({
